...
def copy_test_data(example_root: Path, gigapose_root: Path, scene="000000", exp_gt='', exp_gt_info=''):
    ...
    files = {
        ...
        example_root / "rgb.png":
            lmo_root / "rgb" / f"{scene}.png",
        example_root / "depth.png":
...
def main():
    ...
    p.add_argument("--export_root",  default="../../SharedData/WebsocketData/000000/0/",
                   help="Folder containing SAM6D raw: e.g. exported/000000/0/SAM6D")
    p.add_argument("--example_root",  default="./Data/Example", 
                   help="Target folder for this run: e.g. Data/Example")
    p.add_argument("--cad", default="obj_000001.ply",        
    ...
    p.add_argument("--scene_name",     default="120")
    ...
    p.add_argument("--test_all",     default=True,
    ...
    for name in ("rgb.png", "depth.png", "camera.json"):
        src = os.path.join(exp_sam, "SAM6D", name)
    ...
    if args.test_all_primary == True:
        ...
        run([
            ...
            "--rgb_path",         os.path.join('..',dst, "rgb.png"),
            "--depth_path",       os.path.join('..',dst, "depth.png"),
        ...
        dest_ism_result_file =  "./Data/Example/outputs/sam6d_results/detection_ism.json"
        copy_if_exists(ism_result_file, dest_ism_result_file)
    
        ism_mask_file = os.path.join(args.primary_result_file, 'Pose','MaskISM.png')
        dest_ism_mask_file =  "./Data/Example/outputs/sam6d_results/mask_ism.png"
        ...
        dest_ism_vis_file =  "./Data/Example/outputs/sam6d_results/vis_ism.png"
    ...
    run([
        ...
        "--depth_path", os.path.join('..', dst, "depth.png"),
        "--cam_path",   os.path.join('..', dst, "camera.json"),
        "--seg_path",   os.path.join('..', dst, "outputs", "sam6d_results", "detection_ism.json"),
        # "--debug"
    ], cwd="Pose_Estimation_Model")
    ...
    result_dst = os.path.join("../..", "Result", args.object_type, args.visibility, args.lighting, args.distance, args.height, scene_name, "SAM6D")
    ...
    input_result_dst = os.path.join(result_dst, "../","Input")
    score_result_dst = os.path.join(result_dst, "Scores")


    copy_if_exists(args.export_root, input_result_dst, True)
